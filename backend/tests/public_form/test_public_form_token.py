...
def test_regenerate_token_deactivates_old_and_creates_new_atomically(
    ...
    old_token = token_service.regenerate_token(db_session, persisted_workspace.id, persisted_workspace.tenant_id)
...
def test_tokens_from_different_workspaces_do_not_interfere(
    ...
    token1 = token_service.regenerate_token(db_session, persisted_workspace.id, persisted_workspace.tenant_id)
    token2 = token_service.regenerate_token(db_session, workspace2.id, workspace2.tenant_id)
